...
if DATABASE_URL:
    ...
    def init_db():
        ...
        tables=[
            "CREATE TABLE IF NOT EXISTS agents (id TEXT PRIMARY KEY, nome TEXT NOT NULL, cognome TEXT NOT NULL, cf TEXT NOT NULL, discord TEXT NOT NULL, grado TEXT NOT NULL, stato TEXT NOT NULL DEFAULT 'Attivo', sanzione TEXT, note TEXT, \"dataIngresso\" TEXT NOT NULL, agent_pwd TEXT)",
            "CREATE TABLE IF NOT EXISTS history (id TEXT PRIMARY KEY, \"agentId\" TEXT NOT NULL, \"agentNome\" TEXT NOT NULL, tipo TEXT NOT NULL, vecchio TEXT NOT NULL, nuovo TEXT NOT NULL, motivo TEXT NOT NULL, data TEXT NOT NULL)",
            "CREATE TABLE IF NOT EXISTS comunicati (id TEXT PRIMARY KEY, titolo TEXT NOT NULL, corpo TEXT NOT NULL, priorita TEXT NOT NULL DEFAULT 'normale', data TEXT NOT NULL, \"readBy\" TEXT NOT NULL DEFAULT '[]')",
            "CREATE TABLE IF NOT EXISTS settings (key TEXT PRIMARY KEY, value TEXT NOT NULL)",
            "CREATE TABLE IF NOT EXISTS pec (id TEXT PRIMARY KEY, \"mittenteId\" TEXT NOT NULL, \"mittenteNome\" TEXT NOT NULL, \"destinatarioId\" TEXT NOT NULL, \"destinatarioNome\" TEXT NOT NULL, oggetto TEXT NOT NULL, corpo TEXT NOT NULL, priorita TEXT NOT NULL DEFAULT 'normale', stato TEXT NOT NULL DEFAULT 'inviata', letta BOOLEAN NOT NULL DEFAULT FALSE, data TEXT NOT NULL)",
            "CREATE TABLE IF NOT EXISTS documenti (id TEXT PRIMARY KEY, titolo TEXT NOT NULL, descrizione TEXT, url TEXT, icona TEXT, stato TEXT, categoria TEXT NOT NULL DEFAULT 'altro', ordine INTEGER DEFAULT 0)",
            "CREATE TABLE IF NOT EXISTS segnalazioni (id TEXT PRIMARY KEY, titolo TEXT NOT NULL, corpo TEXT NOT NULL, priorita TEXT NOT NULL DEFAULT 'normale', \"mittenteId\" TEXT NOT NULL, \"mittenteNome\" TEXT NOT NULL, stato TEXT NOT NULL DEFAULT 'aperta', data TEXT NOT NULL)",
            "CREATE TABLE IF NOT EXISTS discord_sessions (token TEXT PRIMARY KEY, discord_id TEXT NOT NULL, discord_username TEXT NOT NULL, discord_avatar TEXT, livello TEXT NOT NULL, grado TEXT, agent_id TEXT, created_at TEXT NOT NULL, expires_at TEXT NOT NULL)",
        ]
        ...
        conn.commit()
        # ALTER in transazione separata — su PG "ADD COLUMN" fallisce se colonna esiste
        try:
        ...
        try:
            ...
            if cnt==0:
                docs=[
                    (str(uuid.uuid4())[:12],"Regolamento Interno","Regolamento interno della Polizia d'Estovia","https://docs.google.com/document/d/1YRyLrOUOelm3PZMIvAZ4NOmLt92qQhVfB55ueU0s3Oo/edit","📋","","regolamenti",1),
                    (str(uuid.uuid4())[:12],"Protocolli Operativi Interni","Protocolli e procedure operative","https://docs.google.com/document/d/1tBs-bCDnqOwWT3eRDaoZvsqVidhyAKM4bHhRSz24SkI/edit","⚙️","","regolamenti",2),
                    (str(uuid.uuid4())[:12],"Codice Disciplinare Interno","Norme disciplinari del personale","https://docs.google.com/document/d/1QsSsq5p7SjiW6nLuozUKHShQE4HJTnDBrP7SiXziNjQ/edit","⚖️","","regolamenti",3),
                    (str(uuid.uuid4())[:12],"Normativa Cautelare","Normativa di garanzia","https://docs.google.com/document/d/1u4OIkEOxXm5zhs0e_bd4nUJPHBz4rOFeF0z4910LbRM/edit","🛡️","","normative",1),
                    (str(uuid.uuid4())[:12],"Costituzione d'Estovia","Normativa fondamentale","https://docs.google.com/document/d/1AxN9YP6YTot_vNNpKkZRzVE6hUvGQ0ertdrGt2T85eg/edit","🏛️","","fondamentale",1),
                    (str(uuid.uuid4())[:12],"Codice Penale","Codice penale","https://docs.google.com/document/d/1qcHd2Y3LMf_6VTIOuh2St-LVyocK6xv_aPT_Q841PcU/edit","⚖️","","codici",3),
                    (str(uuid.uuid4())[:12],"Codice Civile","","","📖","In fase di emissione","codici",1),
                    (str(uuid.uuid4())[:12],"Codice Stradale","","","🚗","In fase di emissione","codici",2),
                ]
                for d in docs: c.execute("INSERT INTO documenti (id,titolo,descrizione,url,icona,stato,categoria,ordine) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)",d)
                conn.commit()
        except Exception as e:
            conn.rollback(); print(f"[init_db] {e}")
        conn.close()
